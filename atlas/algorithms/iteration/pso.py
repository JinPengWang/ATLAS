...
@register_algorithm("pso", aliases=["pso_nfe"])
class PSO(BaseAlgorithm):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        super().__init__(problem, max_iter=max_iter, pop_size=pop_size, seed=seed, verbose=verbose, w=w, c1=c1, c2=c2, **kwargs)
        self.w = w
        self.c1 = c1
        self.c2 = c2
    ...
    def iterate(self, iter_idx: int) -> float:
        ...
        # Position update
        self.population = self._clip(self.population + self.velocity)
